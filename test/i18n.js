...
describe('SEO-friendly sitemap generator: I18n', function () {

  before(function () {
    hexo.config.language = ['default', 'en', 'es'];
  ...
  it('should generate localized links to index pages if index_i18n is truthy', function () {
    var expectedDirectory = path.join(__dirname, 'expected/i18n'),
