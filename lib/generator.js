...
var googleFriendlySitemap = function (locals) {
    ...
    var getIndexSitemapData = function (buffer) {
        var templateContent = buffer.toString(),
            lastUpdated = _.first(posts).updated,
    ...
    var getPostSitemapData = function (buffer) {
        var templateContent = buffer.toString(),
            sitemapTmpl = ejs.compile(templateContent, {
                compileDebug: true,
                filename: sitemapFilePath
            }),
            xml = sitemapTmpl({
                config: config,
                posts: posts
